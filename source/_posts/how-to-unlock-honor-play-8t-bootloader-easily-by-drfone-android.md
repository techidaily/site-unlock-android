...
As one of the initial measures, backup the Honor Play 8T device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Honor Play 8T device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Honor Play 8T device in bootloader mode. Disconnect the Honor Play 8T  device from the PC and turn the Honor Play 8T device off completely. Press the volume down button along with the power button to switch the Honor Play 8T device on in bootloader mode.
...
Step 5: Use the volume keys of the Honor Play 8T device to select Fastboot option along with pressing power button to confirm, after the Honor Play 8T device is in bootloader mode. Now, connect the Honor Play 8T device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Honor Play 8T  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Honor Play 8T device in the command prompt. So, if the Honor Play 8T device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Honor Play 8T device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Honor Play 8T , one message will appear asking if you want to unlock the Honor Play 8T device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Honor Play 8T  device will restart once and it’s done. The device is now bootloader unlocked.
