---
title: In 2024, How to Unlock Honor 70 Lite 5G Phone with Broken Screen
date: 2025-02-09T16:56:10.113Z
updated: 2025-02-12T19:56:26.811Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Honor 70 Lite 5G Phone with Broken Screen
excerpt: This article describes How to Unlock Honor 70 Lite 5G Phone with Broken Screen
keywords: how to reset voicemail password,how to unlock android phone without google account,Honor 70 Lite 5G disable lock screen,remove screen lock pin on android device,Honor 70 Lite 5G get into locked phone,Honor 70 Lite 5G pattern unlock without password,password unlock tool,Honor 70 Lite 5G unlock android phone pattern lock without factory reset,how to reset a phone that is locked,Honor 70 Lite 5G android device manager unlock,unlock,android device screen lock
thumbnail: https://thmb.techidaily.com/d24334e679d3e178a2e8d9f5b333fac2b20b9134a044e30e2240a2331d8bec84.jpg
---

## How to Unlock Honor 70 Lite 5G Phone with Broken Screen

Seeing as the only way to control your Honor 70 Lite 5G deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Honor 70 Lite 5G device. Here’s how to use this bridge.
...
**Step 4:** Connect the Honor 70 Lite 5G device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Honor 70 Lite 5G device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Honor 70 Lite 5G devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Honor 70 Lite 5G device’s password lock.
...
## How to Bypass Android Lock Screen Using Emergency Call On Honor 70 Lite 5G?
...
- Step 3. Choose the Honor 70 Lite 5G device you want to unlock in ADM interface
...
To bypass the Honor lock screen in this method, you ought to be an advanced user who knows what are "custom recovery" and "rooting". You have to install any kind of customer recovery, and you should have an SD card on your phone. SD card is required to move a ZIP file to the phone, and it is the only way to transfer the file when the Honor 70 Lite 5G device is locked.
...
A factory reset is the best option in almost any case if one of these solutions couldn't work. According to your device type, the process may vary. In most devices, you have to turn off the Honor 70 Lite 5G device completely to start the process. But this method will delete all the precious data on the Honor 70 Lite 5G device after the factory reset.
...
- Step 3. Now you can access the Honor 70 Lite 5G device completely
- Step 4. Go to the security settings of the Honor 70 Lite 5G device and remove the pattern or pin.
...
As one of the initial measures, backup the Honor 70 Lite 5G device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Honor 70 Lite 5G device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Honor 70 Lite 5G device in bootloader mode. Disconnect the Honor 70 Lite 5G  device from the PC and turn the Honor 70 Lite 5G device off completely. Press the volume down button along with the power button to switch the Honor 70 Lite 5G device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Honor 70 Lite 5G device to select Fastboot option along with pressing power button to confirm, after the Honor 70 Lite 5G device is in bootloader mode. Now, connect the Honor 70 Lite 5G device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Honor 70 Lite 5G  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Honor 70 Lite 5G device in the command prompt. So, if the Honor 70 Lite 5G device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Honor 70 Lite 5G device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Honor 70 Lite 5G , one message will appear asking if you want to unlock the Honor 70 Lite 5G device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Honor 70 Lite 5G  device will restart once and it’s done. The device is now bootloader unlocked.
