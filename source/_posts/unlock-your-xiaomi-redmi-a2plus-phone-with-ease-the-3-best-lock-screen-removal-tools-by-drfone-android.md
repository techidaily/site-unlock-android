...
date: 2024-04-30T03:00:37.077Z
updated: 2024-05-01T03:00:37.077Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: forgot android device password,get into locked phone,Xiaomi Redmi A2+ unlock screen,oem unlock missing,Xiaomi Redmi A2+ pattern unlock without password,remove forgotten pin android,full guide to unlock
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Xiaomi Redmi A2+ device. Here’s how to use this bridge.
...
**Step 4:** Connect the Xiaomi Redmi A2+ device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Xiaomi Redmi A2+ device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Xiaomi Redmi A2+ devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Xiaomi Redmi A2+ device’s password lock.
