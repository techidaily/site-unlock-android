---
title: How to Reset a ZTE Axon 40 Lite Phone that is Locked?
date: 2024-07-18T14:41:38.325Z
updated: 2024-07-19T14:41:38.325Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Reset a ZTE Axon 40 Lite Phone that is Locked?
excerpt: This article describes How to Reset a ZTE Axon 40 Lite Phone that is Locked?
keywords: android device screen lock,remove screen lock pin on android,ZTE Axon 40 Lite password unlock tool,fingerprint not working,network unlock,ZTE Axon 40 Lite fingerprint lock for android,how to unlock android device phone without google account,top anti theft apps,oem unlock missing,gusture lock screen
...
ADB creates a bridge between the PC and your device which can then be used to unlock the ZTE Axon 40 Lite device. Here’s how to use this bridge.
...
**Step 4:** Connect the ZTE Axon 40 Lite device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the ZTE Axon 40 Lite device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the ZTE Axon 40 Lite devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the ZTE Axon 40 Lite device’s password lock.
