---
title: How to Unlock Honor PIN Code/Pattern Lock/Password
date: 2024-07-18T17:38:16.071Z
updated: 2024-07-19T17:38:16.071Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Honor PIN Code/Pattern Lock/Password
excerpt: This article describes How to Unlock Honor PIN Code/Pattern Lock/Password
keywords: smart lock android device,get into locked phone,how to reset voicemail password,how to unlock android phone,network unlock,Honor X9b how to change lock screen password,unlock phone guide,Honor X9b fingerprint lock for android,Honor X9b pattern unlock,Honor X9b top 10 frp bypass tools,Honor X9b gusture lock screen
...
As one of the initial measures, backup the Honor X9b device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Honor X9b device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Honor X9b device in bootloader mode. Disconnect the Honor X9b  device from the PC and turn the Honor X9b device off completely. Press the volume down button along with the power button to switch the Honor X9b device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Honor X9b device to select Fastboot option along with pressing power button to confirm, after the Honor X9b device is in bootloader mode. Now, connect the Honor X9b device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Honor X9b  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Honor X9b device in the command prompt. So, if the Honor X9b device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Honor X9b device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Honor X9b , one message will appear asking if you want to unlock the Honor X9b device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Honor X9b  device will restart once and it’s done. The device is now bootloader unlocked.
