---
title: In 2024, How to Reset a Google Phone that is Locked?
date: 2024-09-18T16:13:47.410Z
updated: 2024-09-19T18:17:52.570Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: bypass lock screen password,Google Pixel 8 Pro smart lock android,lock screen apps for android device,Google Pixel 8 Pro unlock apps for android,top 10 frp bypass tools,unlock with google assistant,samfw frp tool,lock apps with fingerprint,remove screen lock pin on android,bypass android face lock
...
As one of the initial measures, backup the Google Pixel 8 Pro device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Google Pixel 8 Pro device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Google Pixel 8 Pro device in bootloader mode. Disconnect the Google Pixel 8 Pro  device from the PC and turn the Google Pixel 8 Pro device off completely. Press the volume down button along with the power button to switch the Google Pixel 8 Pro device on in bootloader mode.
...
Step 5: Use the volume keys of the Google Pixel 8 Pro device to select Fastboot option along with pressing power button to confirm, after the Google Pixel 8 Pro device is in bootloader mode. Now, connect the Google Pixel 8 Pro device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Google Pixel 8 Pro  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Google Pixel 8 Pro device in the command prompt. So, if the Google Pixel 8 Pro device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Google Pixel 8 Pro device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Google Pixel 8 Pro , one message will appear asking if you want to unlock the Google Pixel 8 Pro device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Google Pixel 8 Pro  device will restart once and it’s done. The device is now bootloader unlocked.

## Rootjunky APK To Bypass Google FRP Lock For Google Pixel 8 Pro
...
FRP automatically activates when you add a Google account to your Android phone. It links the Google Pixel 8 Pro device to your account, making it the “trusted owner.” Once activated, FRP becomes embedded in the phone’s system.
