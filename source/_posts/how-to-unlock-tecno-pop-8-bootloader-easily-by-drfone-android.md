...
As one of the initial measures, backup the Tecno Pop 8 device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Tecno Pop 8 device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Tecno Pop 8 device in bootloader mode. Disconnect the Tecno Pop 8  device from the PC and turn the Tecno Pop 8 device off completely. Press the volume down button along with the power button to switch the Tecno Pop 8 device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Tecno Pop 8 device to select Fastboot option along with pressing power button to confirm, after the Tecno Pop 8 device is in bootloader mode. Now, connect the Tecno Pop 8 device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Tecno Pop 8  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Tecno Pop 8 device in the command prompt. So, if the Tecno Pop 8 device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Tecno Pop 8 device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Tecno Pop 8 , one message will appear asking if you want to unlock the Tecno Pop 8 device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Tecno Pop 8  device will restart once and it’s done. The device is now bootloader unlocked.
...
## Best Ways on How to Unlock/Bypass/Swipe/Remove Tecno Pop 8 Fingerprint Lock
...
**Step 2.** Connect your Android phone and then select the Tecno Pop 8 device mode on the list. If it's not on the list, select "I can't find my device model from the list above".
