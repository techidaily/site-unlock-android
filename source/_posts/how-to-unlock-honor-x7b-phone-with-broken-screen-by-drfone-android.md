---
title: How to Unlock Honor X7b Phone with Broken Screen
date: 2024-07-18T17:38:47.571Z
updated: 2024-07-19T17:38:47.571Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Honor X7b Phone with Broken Screen
excerpt: This article describes How to Unlock Honor X7b Phone with Broken Screen
keywords: Honor X7b change android lock screen,Honor X7b remove screen lock pin on android,Honor X7b pattern lock screen,how to unlock android device phone,Honor X7b how to reset a phone that is locked,unlock android device phone without pin,Honor X7b lock screen pattern,oem unlock missing,unlock android phone password without factory reset
thumbnail: https://thmb.techidaily.com/8ec7f9d19b5395810145f1bf31b1db142a6ba9be6ed8b5f1e4a621d2eef1f390.jpg
---

## How to Unlock Honor X7b Phone with Broken Screen

Seeing as the only way to control your Honor X7b deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Honor X7b device. Here’s how to use this bridge.
...
**Step 4:** Connect the Honor X7b device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Honor X7b device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Honor X7b devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Honor X7b device’s password lock.
