---
title: How to Unlock Itel A05s Phone Pattern Lock without Factory Reset
date: 2024-06-18T02:26:34.524Z
updated: 2024-06-19T02:26:34.524Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Itel A05s Phone Pattern Lock without Factory Reset
excerpt: This article describes How to Unlock Itel A05s Phone Pattern Lock without Factory Reset
keywords: enable usb debugging,android lock screen settings,Itel A05s fingerprint lock for android,unlock android device phone password without factory reset,Itel A05s hard pattern lock,Itel A05s lock screen apps for android,android device pattern lock remover,android device emergency call bypass
...
As one of the initial measures, backup the Itel A05s device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Itel A05s device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Itel A05s device in bootloader mode. Disconnect the Itel A05s  device from the PC and turn the Itel A05s device off completely. Press the volume down button along with the power button to switch the Itel A05s device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Itel A05s device to select Fastboot option along with pressing power button to confirm, after the Itel A05s device is in bootloader mode. Now, connect the Itel A05s device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Itel A05s  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Itel A05s device in the command prompt. So, if the Itel A05s device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Itel A05s device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Itel A05s , one message will appear asking if you want to unlock the Itel A05s device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Itel A05s  device will restart once and it’s done. The device is now bootloader unlocked.
