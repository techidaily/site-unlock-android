---
title: In 2024, How to Unlock Vivo Y200e 5G Phone with Broken Screen
date: 2024-04-30T02:54:22.177Z
updated: 2024-05-01T02:54:22.177Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Vivo Y200e 5G Phone with Broken Screen
excerpt: This article describes How to Unlock Vivo Y200e 5G Phone with Broken Screen
keywords: enable usb debugging,disable lock screen,Vivo Y200e 5G android pattern lock remover,gusture lock screen,password unlock tool,Vivo Y200e 5G bypass android lock screen using emergency call,unlock android phone password without factory reset
thumbnail: https://www.lifewire.com/thmb/Ov60TE6o0ZdI6Oaw589hEL_tVLg=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-944229088-5bd1f61e46e0fb0026fdf2f0.jpg
---

## How to Unlock Vivo Y200e 5G Phone with Broken Screen

Seeing as the only way to control your Vivo Y200e 5G deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Vivo Y200e 5G device. Here’s how to use this bridge.
...
**Step 4:** Connect the Vivo Y200e 5G device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
**Step 2:** As soon as the Vivo Y200e 5G devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Vivo Y200e 5G device’s password lock.
...
## Unlock Your Vivo Y200e 5G's Potential: The Top 20 Lock Screen Apps You Need to Try
...
As one of the initial measures, backup the Vivo Y200e 5G device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Vivo Y200e 5G device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Vivo Y200e 5G device in bootloader mode. Disconnect the Vivo Y200e 5G  device from the PC and turn the Vivo Y200e 5G device off completely. Press the volume down button along with the power button to switch the Vivo Y200e 5G device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Vivo Y200e 5G device to select Fastboot option along with pressing power button to confirm, after the Vivo Y200e 5G device is in bootloader mode. Now, connect the Vivo Y200e 5G device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Vivo Y200e 5G  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Vivo Y200e 5G device in the command prompt. So, if the Vivo Y200e 5G device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Vivo Y200e 5G device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Vivo Y200e 5G , one message will appear asking if you want to unlock the Vivo Y200e 5G device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Vivo Y200e 5G  device will restart once and it’s done. The device is now bootloader unlocked.
