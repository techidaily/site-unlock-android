...
date: 2024-07-18T13:03:40.110Z
updated: 2024-07-19T13:03:40.110Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Vivo S18 Phone with Broken Screen
excerpt: This article describes How to Unlock Vivo S18 Phone with Broken Screen
keywords: unlock android device phone pattern lock without factory reset,Vivo S18 hack wifi password android,reset locked android device phone,pattern unlock,Vivo S18 easy pattern lock,android device pattern lock remover,android device lock screen settings,Vivo S18 gusture lock screen,Vivo S18 best sim location trackers,bypass android device lock screen using emergency call,Vivo S18 unlock android phone password without factory reset
thumbnail: https://thmb.techidaily.com/7270266df833210c4618ef395558e4a1dd14a566be785a358865debf94836fef.jpg
---

## How to Unlock Vivo S18 Phone with Broken Screen

Seeing as the only way to control your Vivo S18 deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Vivo S18 device. Here’s how to use this bridge.
...
**Step 4:** Connect the Vivo S18 device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Vivo S18 device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Vivo S18 devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Vivo S18 device’s password lock.
...
If your fingerprint is not working or the Vivo S18 device prompts you with an error in the fingerprint functioning, possibly the fingerprint reader is not responding, and the Vivo S18 device needs to restart to get rid of this error.

![phone restart ui](https://images.wondershare.com/drfone/article/2022/11/how-to-bypass-android-fingerprint-lock-3.jpg)

When a device restarts, the fingerprint functionality is restored after entering the Vivo S18 device pattern, password, or PIN. This is the simplest method to reset your fingerprint hardware.
...
4. Once more, select "Erase." This will reset the Vivo S18 device and get rid of the dysfunctional fingerprint lock.
