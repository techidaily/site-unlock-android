---
title: Pattern Locks Are Unsafe Secure Your Honor 90 Pro Phone Now with These Tips
date: 2024-08-24T17:43:00.783Z
updated: 2024-08-25T17:43:00.783Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Pattern Locks Are Unsafe Secure Your Honor 90 Pro Phone Now with These Tips
excerpt: This article describes Pattern Locks Are Unsafe Secure Your Honor 90 Pro Phone Now with These Tips
keywords: Honor 90 Pro locked out of android phone,how to unlock android device phone,lock screen apps for android,Honor 90 Pro samfw frp tool,delete gmail account with without password,Honor 90 Pro turn off google smart lock,Honor 90 Pro swipe screen to unlock,Honor 90 Pro android password reset
thumbnail: https://thmb.techidaily.com/1b3acf6f92837e9104aa399e6aa268354b94b6b827af6bb095b68b19082ca48f.png
---

## Pattern Locks Are Unsafe: Secure Your Honor 90 Pro Phone Now with These Tips
...
Remove the Hard Pattern Lock on Your Honor 90 Pro If You Forgot!
...
All data on the Honor 90 Pro device is wiped under this method. Select Samsung phones may be unlocked without data loss. Check [this](https://drfone.wondershare.com/reference/android-lock-screen-removal.html) list for devices that may be unlocked without data loss.
...
As one of the initial measures, backup the Honor 90 Pro device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
<!-- affiliate ads end -->
After selecting the Honor 90 Pro device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Honor 90 Pro device in bootloader mode. Disconnect the Honor 90 Pro  device from the PC and turn the Honor 90 Pro device off completely. Press the volume down button along with the power button to switch the Honor 90 Pro device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Honor 90 Pro device to select Fastboot option along with pressing power button to confirm, after the Honor 90 Pro device is in bootloader mode. Now, connect the Honor 90 Pro device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Honor 90 Pro  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Honor 90 Pro device in the command prompt. So, if the Honor 90 Pro device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Honor 90 Pro device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Honor 90 Pro , one message will appear asking if you want to unlock the Honor 90 Pro device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Honor 90 Pro  device will restart once and it’s done. The device is now bootloader unlocked.
