---
title: In 2024, How to Unlock Itel A60s Pattern Lock if Forgotten? 6 Ways
date: 2024-06-18T02:25:59.239Z
updated: 2024-06-19T02:25:59.239Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Itel A60s Pattern Lock if Forgotten? 6 Ways
excerpt: This article describes How to Unlock Itel A60s Pattern Lock if Forgotten? 6 Ways
keywords: find lost phone with google map,Itel A60s top anti theft apps,bypass android lock screen using emergency call,Itel A60s android emergency call bypass,unlock android phone password without factory reset,unlock android phone with broken screen,reset gmail password on android
...
## Top 10 Password Cracking Tools For Itel A60s
...
As one of the initial measures, backup the Itel A60s device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Itel A60s device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Itel A60s device in bootloader mode. Disconnect the Itel A60s  device from the PC and turn the Itel A60s device off completely. Press the volume down button along with the power button to switch the Itel A60s device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Itel A60s device to select Fastboot option along with pressing power button to confirm, after the Itel A60s device is in bootloader mode. Now, connect the Itel A60s device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Itel A60s  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Itel A60s device in the command prompt. So, if the Itel A60s device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Itel A60s device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Itel A60s , one message will appear asking if you want to unlock the Itel A60s device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Itel A60s  device will restart once and it’s done. The device is now bootloader unlocked.
