---
title: Mastering Lock Screen Settings How to Enable and Disable on Google Pixel 8
date: 2024-08-17T04:05:11.033Z
updated: 2024-08-18T04:05:11.033Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Mastering Lock Screen Settings How to Enable and Disable on Google Pixel 8
excerpt: This article describes Mastering Lock Screen Settings How to Enable and Disable on Google Pixel 8
keywords: Google Pixel 8 full guide to unlock,android device lock screen settings,Google Pixel 8 gusture lock screen,unlock phone forgot password,Google Pixel 8 techeligible frp bypass,android show wifi password,gusture lock screen,Google Pixel 8 samfw frp tool,delete gmail account with without password,how to lock apps on android device,Google Pixel 8 how to unlock android phone without google account
thumbnail: https://thmb.techidaily.com/64bcba811dca59ee452fde50283dc6af9516c46b5a87dc01f6fa89f4e4093f9a.jpg
---

## Mastering Lock Screen Settings: How to Enable and Disable on Google Pixel 8
...
As one of the initial measures, backup the Google Pixel 8 device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
<!-- affiliate ads end -->
After selecting the Google Pixel 8 device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Google Pixel 8 device in bootloader mode. Disconnect the Google Pixel 8  device from the PC and turn the Google Pixel 8 device off completely. Press the volume down button along with the power button to switch the Google Pixel 8 device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Google Pixel 8 device to select Fastboot option along with pressing power button to confirm, after the Google Pixel 8 device is in bootloader mode. Now, connect the Google Pixel 8 device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Google Pixel 8  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Google Pixel 8 device in the command prompt. So, if the Google Pixel 8 device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Google Pixel 8 device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Google Pixel 8 , one message will appear asking if you want to unlock the Google Pixel 8 device bootloader.
...
<!-- affiliate ads end -->
Use volume keys to select and power button to confirm. Once this is done, the Google Pixel 8  device will restart once and it’s done. The device is now bootloader unlocked.
...
**Step 4.** To reset the forgot pattern lock, you need to provide the correct Google credentials of the account already linked to the Google Pixel 8 device.
...
<!-- affiliate ads end -->
**Step 5.** After signing in to the interface, you will be asked to provide a new pattern lock for the Google Pixel 8 device.
...
**Step 2.** To use its forgot pattern lock feature, you need to connect your Google Pixel 8 to your system using a USB cable. Once your device has been detected automatically, just click on the "Android"> "Unlock Android Screen" button.
...
**Step 4.** You will get the location of the Google Pixel 8 device with several other options (lock, erase, and ring).
...
<!-- affiliate ads end -->
**Step 2:** After successfully logging in, locate the locked Samsung device. Now, click on the "Unlock" feature. Upon choosing this option, a pop-up window will appear. It will prompt you to input your Samsung account password. Once you've entered your password, proceed to unlock the Google Pixel 8 device by pressing "Next."
...
**Step 1:** Turn off your Samsung device and connect it to your computer. Now press and hold “Volume Up” and “Power” keys for a while. Release the keys once the Google Pixel 8 device enters Recovery Mode.
