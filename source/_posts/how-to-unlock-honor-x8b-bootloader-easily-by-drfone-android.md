...
<!-- affiliate ads end -->
## Part 2: How to Unlock Honor X8b  Bootloader

Honor X8b  is the flagship device of HTC by all means. With a world of features and offerings, Honor X8b  truly is a beast. While the phone is very powerful without any modifications, the true potential is yet to be seen and that can only be done if the bootloader is unlocked. So, to have a complete control over the Honor X8b  device, it is important to unlock the bootloader and the process has to be carried out diligently. One of the initial things that needs to be ensured is that the Honor X8b  device is fully charged or atleast 80% mark. Make sure you have the fastboot drivers for the Honor X8b device configured on the windows machine and the Android SDK. Here are some of the steps which can be followed to unlock bootloader.
...
As one of the initial measures, backup the Honor X8b device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Honor X8b device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Honor X8b device in bootloader mode. Disconnect the Honor X8b  device from the PC and turn the Honor X8b device off completely. Press the volume down button along with the power button to switch the Honor X8b device on in bootloader mode.
...
Step 5: Use the volume keys of the Honor X8b device to select Fastboot option along with pressing power button to confirm, after the Honor X8b device is in bootloader mode. Now, connect the Honor X8b device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Honor X8b  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Honor X8b device in the command prompt. So, if the Honor X8b device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Honor X8b device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Honor X8b , one message will appear asking if you want to unlock the Honor X8b device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Honor X8b  device will restart once and it’s done. The device is now bootloader unlocked.
...
<!-- affiliate ads end -->
## How to Remove Forgotten PIN Of Your Honor X8b
...
1. Will Dr.Fone - Screen Unlock Do Harm To My Honor X8b?
...
## How to Unlock Honor X8b Phone Password Without Factory Reset?
...
- **Step 2.** Then you would need to insert the SD card into your locked phone and then restart the Honor X8b device in recovery mode.
...
_**Note**: Sometimes, the Honor X8b device may ask for a pattern or password. You just need to put in any random pattern/password then it will get unlocked._
