---
title: In 2024, Unlocking the Power of Smart Lock A Beginners Guide for Honor 100 Users
date: 2024-12-07T21:34:09.416Z
updated: 2024-12-11T19:19:56.340Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Unlocking the Power of Smart Lock A Beginners Guide for Honor 100 Users
excerpt: This article describes Unlocking the Power of Smart Lock A Beginners Guide for Honor 100 Users
keywords: Honor 100 android lock screen settings,Honor 100 how to change lock screen password,Honor 100 bypass android face lock,android device device manager unlock,Honor 100 top anti theft apps,Honor 100 forgot android password,pattern lock screen
thumbnail: https://thmb.techidaily.com/92d4d3774b8fd498c6cfb488cbb5cb9a7cceb0aea3bc2d6cdbbe36e4703b4b56.jpg
---

## Unlocking the Power of Smart Lock: A Beginner's Guide for Honor 100 Users
...
The feature recognizes your face and then unlocks the Honor 100 device. Once you set up the Honor 100 device to recognize your face as a trusted face, it will unlock the Honor 100 device as soon as it recognizes you.

![smart lock android](https://images.wondershare.com/drfone/others/14555208588486.jpg)

PRECAUTION:  At best, this can be the first level of security, as one who resembles you to some extent can unlock the Honor 100 device. Photographs are not stored in the system. The device does hold necessary data to recognize your face, and the security level is determined by how good the Honor 100 device is configured. The data is not accessed by any app or loaded onto a Google server for backup.
...
As one of the initial measures, backup the Honor 100 device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Honor 100 device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Honor 100 device in bootloader mode. Disconnect the Honor 100  device from the PC and turn the Honor 100 device off completely. Press the volume down button along with the power button to switch the Honor 100 device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Honor 100 device to select Fastboot option along with pressing power button to confirm, after the Honor 100 device is in bootloader mode. Now, connect the Honor 100 device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Honor 100  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Honor 100 device in the command prompt. So, if the Honor 100 device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Honor 100 device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Honor 100 , one message will appear asking if you want to unlock the Honor 100 device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Honor 100  device will restart once and it’s done. The device is now bootloader unlocked.

## How To Track IMEI Number Of Honor 100 Through Google Earth?
...
## Part 1: How To Track Your Honor 100 on Google Earth
...
- **No Need for Special Apps.**Unlike many other tracking methods, IMEI tracking doesn't require any special apps or software to be installed on the Honor 100 device you want to track. It relies on the unique IMEI number of the Honor 100 device.
...
- **Internet and Network Dependency.**IMEI tracking depends on the Honor 100 device being connected to the internet or a mobile network. If the Honor 100 device is turned off, in airplane mode, or disconnected, tracking may be impossible.
...
- **Step 8:** The next screen displays the unlocking iOS device's progress bar. Keep in mind that the Honor 100 device must be connected at all times; otherwise, it will brick.
