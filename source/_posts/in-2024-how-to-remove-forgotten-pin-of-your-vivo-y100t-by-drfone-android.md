---
title: In 2024, How to Remove Forgotten PIN Of Your Vivo Y100t
date: 2024-04-30T02:54:50.416Z
updated: 2024-05-01T02:54:50.416Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Remove Forgotten PIN Of Your Vivo Y100t
excerpt: This article describes How to Remove Forgotten PIN Of Your Vivo Y100t
keywords: unlock android phone password without factory reset,Vivo Y100t unlock android phone with broken screen,Vivo Y100t locked out of android phone,fingerprint lock for android device,Vivo Y100t android show wifi password,turn off google smart lock,bypass android device face lock,Vivo Y100t lock screen pattern,unlock android phone without pin,Vivo Y100t full guide to unlock,Vivo Y100t reset locked android phone
...
## Unlocking the Power of Smart Lock: A Beginner's Guide for Vivo Y100t Users
...
Android Lollipop added a feature called Smart Lock, and the feature was devised as a smart tool to prevent the Android phone from locking once it was initially unlocked. In other words, the feature overrides an Android phone's Lock Screen feature, thereby saving users the need to enter passwords every time the Vivo Y100t device locks.
...
Since you have already paired Bluetooth, it will ask you to choose the Vivo Y100t device from the list.
...
The feature recognizes your face and then unlocks the Vivo Y100t device. Once you set up the Vivo Y100t device to recognize your face as a trusted face, it will unlock the Vivo Y100t device as soon as it recognizes you.

![smart lock android](https://images.wondershare.com/drfone/others/14555208588486.jpg)

PRECAUTION:  At best, this can be the first level of security, as one who resembles you to some extent can unlock the Vivo Y100t device. Photographs are not stored in the system. The device does hold necessary data to recognize your face, and the security level is determined by how good the Vivo Y100t device is configured. The data is not accessed by any app or loaded onto a Google server for backup.
...
The device begins to gather data about your face. The trusted face icon appears. As a backup, in case Smart Lock does not recognize your face, use the manual system by applying the PIN or password to unlock the Vivo Y100t device.
