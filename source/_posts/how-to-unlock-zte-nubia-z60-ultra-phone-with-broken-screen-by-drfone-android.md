---
title: How to Unlock ZTE Nubia Z60 Ultra Phone with Broken Screen
date: 2024-07-18T14:51:53.848Z
updated: 2024-07-19T14:51:53.848Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: ZTE Nubia Z60 Ultra enable usb debugging,unlock android phone with broken screen,ZTE Nubia Z60 Ultra pattern lock screen,ZTE Nubia Z60 Ultra unlock android phone pattern lock without factory reset,how to lock apps on android device,forgot android password,network unlock,lock screen pattern
...
## A Perfect Guide To Remove or Disable Google Smart Lock On ZTE Nubia Z60 Ultra
...
The first one is on-body detection, which keeps the ZTE Nubia Z60 Ultra device unlocked when it's carried or held by the user. The other two are “Trusted Places” and “Trusted Devices.” Users can set specific locations, like home or work, as "Trusted Places." When the ZTE Nubia Z60 Ultra device is within these locations, it remains unlocked and accessible. Smart Lock integrates biometric authentication methods to unlock devices.
...
Disabling the Google Smart Lock can have a side effect, which is the danger of forgetting an important password. One of these important passwords is the screen lock on your Android device. These scenarios could involve forgetting the ZTE Nubia Z60 Ultra device's PIN, pattern, or password. This could be essential for unlocking the phone or accessing its functionalities. It can lead to being locked out of the ZTE Nubia Z60 Ultra device, hindering normal operations.
...
Select your device brand and "100% Remove Screen Lock." Selecting the ZTE Nubia Z60 Ultra device brand initiates access to the designated mode. It will trigger Dr.Fone to commence unlocking the Android screen. Note that entering specific modes varies depending on the ZTE Nubia Z60 Ultra device brand. Upon successfully unlocking your Android device screen, tap "Done."
