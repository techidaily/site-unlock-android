---
title: Top 12 Prominent Honor 100 Pro Fingerprint Not Working Solutions
date: 2024-08-17T04:04:04.825Z
updated: 2024-08-18T04:04:04.825Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Top 12 Prominent Honor 100 Pro Fingerprint Not Working Solutions
excerpt: This article describes Top 12 Prominent Honor 100 Pro Fingerprint Not Working Solutions
keywords: Honor 100 Pro delete gmail account with without password,Honor 100 Pro android lock screen settings,password unlock tool,remove forgotten pin android,hard pattern lock,Honor 100 Pro locked out of android phone,forgot pattern lock,gusture lock screen,fingerprint lock app
...
## Remove the Lock Screen Fingerprint Of Your Honor 100 Pro
...
If your fingerprint is not working or the Honor 100 Pro device prompts you with an error in the fingerprint functioning, possibly the fingerprint reader is not responding, and the Honor 100 Pro device needs to restart to get rid of this error.
...
<!-- affiliate ads end -->
When a device restarts, the fingerprint functionality is restored after entering the Honor 100 Pro device pattern, password, or PIN. This is the simplest method to reset your fingerprint hardware.
...
4. Once more, select "Erase." This will reset the Honor 100 Pro device and get rid of the dysfunctional fingerprint lock.
...
## How To Unlock Honor 100 Pro Phone Without Password?
...
You need to log into the Google account that is associated with the Honor 100 Pro device, then do the following:
...
- You must enter the Gmail account that is associated with the Honor 100 Pro device here before selecting "Next."
...
Using your Google account is a superb method for finding the Honor 100 Pro device when lost or stolen.
...
To bypass the Android lock screen, all you need to do is sign into the Honor 100 Pro device's associated Google account and then follow these steps:
...
- After choosing the Honor 100 Pro device, select one of the three options, "lock," from the list.
- There will be a new pop-up window that you can use to change the Honor 100 Pro device password. Additionally, you can choose to add a phone number or recovery email.
...
- Here, you must use a USB cable to connect your Honor 100 Pro to the computer
...
When your phone is locked, you may access the recovery menu of your phone using its physical keys and choose to hard reset the Honor 100 Pro device. Here's how to restore a locked phone to factory settings.
...
- Press the Power button on your phone for around 30 seconds, or until the Honor 100 Pro device restarts.
...
![choose the Honor 100 Pro device model](https://images.wondershare.com/drfone/guide/screen-unlock-any-android-device-2.png)
