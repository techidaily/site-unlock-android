---
title: How to Unlock Honor X50 GT Phone with Broken Screen
date: 2024-07-03T21:51:31.611Z
updated: 2024-07-04T21:51:31.611Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Honor X50 GT Phone with Broken Screen
excerpt: This article describes How to Unlock Honor X50 GT Phone with Broken Screen
keywords: Honor X50 GT get into locked phone,Honor X50 GT how to change lock screen password,Honor X50 GT unlock,Honor X50 GT enable usb debugging,universal unlock pattern for android,unlock android phone with broken screen,pattern unlock without password,lock screen apps for android,Honor X50 GT lock screen apps for android,remove screen lock pin on android device,unlock android phone pattern lock without factory reset,lock apps with fingerprint
thumbnail: https://thmb.techidaily.com/fff656b551e024a92bec77f08e34169fdbb7972daf3e003aecf76e9fd40fed20.jpg
---

## How to Unlock Honor X50 GT Phone with Broken Screen

Seeing as the only way to control your Honor X50 GT deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Honor X50 GT device. Here’s how to use this bridge.
...
**Step 4:** Connect the Honor X50 GT device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Honor X50 GT device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Honor X50 GT devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Honor X50 GT device’s password lock.
...
## Unlock Your Honor X50 GT's Potential: The Top 20 Lock Screen Apps You Need to Try
